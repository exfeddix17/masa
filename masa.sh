...
curl -s https://raw.githubusercontent.com/exfeddix17/cryptohodl/main/ufw.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/exfeddix17/cryptohodl/main/go.sh | bash &>/dev/null
